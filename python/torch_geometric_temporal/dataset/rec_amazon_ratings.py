...
path = '/mnt/data/dataset/rec-amazon-ratings/rec-amazon-ratings.edges'
window = 100
is_weighted = True
delimiter = ','
skip_header = 2
...
class RecAmazonRatingsDatasetLoader(object):
    def __init__(self):
        # self.N = N
    ...
    def _read_web_data(self):
        ...
        print('snapshots:{0}, edge_num:{1},vertex_num:{2},edge_life_num:{3}'.format(self.snapshot_count, self.edge_num,
                                                                                    self.N, self.edge_life_num))
